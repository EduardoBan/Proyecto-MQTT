...
class DdlPuntoMedicion extends Component {
  ...
  fetchPuntodeMedicion = (inputValue = 1, callback) => {
    setTimeout(() => {
      axios
      //  .get("http://localhost:5000/puntodemedicion")
        .get("http://64.181.164.73:5000/puntodemedicion")
        .then((resp) => {
...
export default DdlPuntoMedicion;
